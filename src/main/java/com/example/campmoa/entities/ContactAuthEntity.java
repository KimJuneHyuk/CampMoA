...
public class ContactAuthEntity  {
    ...
    public ContactAuthEntity(int index, String contact, String code, String salt, Date created_at, Date expires_at, boolean expired_flag) {
        this.index = index;
