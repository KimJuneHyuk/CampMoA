...
//     const selectedCityElement = subContainer.querySelector('.country[data-value][selected]');
//     return cities.find(x => x['continentValue'] === selectedContinent['value'] && x['value'] === selectedCityElement.dataset.value)
// };
//
...
// //         .querySelectorAll('.region[data-value]')
// //         .forEach(x => x.removeAttribute('selected'));
// //     const selectedCountryValue = getSelectedCity()['value'];
...
//     cities.filter(x => x['continentValue'] === continent['value'])
//         .forEach(city => {
//             const subElement = window.document.createElement('div');
//             subElement.classList.add('sub');
//             const cityElement = window.document.createElement('div');
//             cityElement.classList.add('country');
//             cityElement.dataset.value = city['value'];
//             cityElement.innerText = city['text'];
...
//
//
//             // subElement.append(cityElement, regionContainerElement);
//             subElement.append(cityElement);
//
//
...
//     const selectedCountry = getSelectedCity()['value'];
...
//     const selectedContinent = getSelectedContinent();
//     const selectedCountry = getSelectedCity();
...
//                     locationTextElement.innerText = cities.find(x =>
//                         x['continentValue'] === article['continentValue'] &&
//                         x['countryValue'] === article['cityValue'] &&
...
//             cities = responseJson['accompanyCountries'];
...
//             console.log('불러온 국가 : ' + cities.length + '개');
//             // console.log('불러온 지역 : ' + regions.length + '개');
//             console.log('지역 중 대륙이 동아시아 인 것만 뽑으면?');
//             cities.filter(x => x['continentValue'] === 'EA').forEach(cities => {
//                 console.log(`이름 : ${cities['text']}`);
//             });
//         } else {
